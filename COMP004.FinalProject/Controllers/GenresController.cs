...
namespace COMP004.FinalProject.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(WebDevAcademyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genres != null ? 
                          ...
                          Problem("Entity set 'WebDevAcademyContext.Genres'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebDevAcademyContext.Genres'  is null.");
            }
            var genre = await _context.Genres.FindAsync(id);
            if (genre != null)
            {
