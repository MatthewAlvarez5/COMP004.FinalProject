...
namespace COMP004.FinalProject.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(WebDevAcademyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publishers != null ? 
                          ...
                          Problem("Entity set 'WebDevAcademyContext.Publishers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebDevAcademyContext.Publishers'  is null.");
            }
            var publisher = await _context.Publishers.FindAsync(id);
            if (publisher != null)
            {
